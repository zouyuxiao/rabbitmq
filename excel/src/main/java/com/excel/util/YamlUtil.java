...
public class YamlUtil
{
    ...
    {
        InputStream in = com.excel.util.YamlUtil.class.getClassLoader().getResourceAsStream(fileName);
    ...
    public static void dumpYaml(String fileName, Map<?, ?> map) throws IOException
    {
        ...
        {
            FileWriter fileWriter = new FileWriter(com.excel.util.YamlUtil.class.getResource(fileName).getFile());
