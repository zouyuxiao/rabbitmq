...
import com.excel.util.YamlUtil;
...
public class Global
{
    private static final Logger log = LoggerFactory.getLogger(com.excel.config.Global.class);
     ...
     * 当前对象实例
     */
    private static com.excel.config.Global global;
     ...
     * 静态工厂方法
     */
    public static synchronized com.excel.config.Global getInstance()
    {
        if (global == null)
        {
            global = new com.excel.config.Global();
        }
        return global;
    }
