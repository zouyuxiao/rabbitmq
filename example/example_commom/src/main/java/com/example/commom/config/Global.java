...
import com.example.commom.utils.YamlUtil;
...
public class Global
{
    private static final Logger log = LoggerFactory.getLogger(com.example.commom.config.Global.class);
     ...
     * 当前对象实例
     */
    private static com.example.commom.config.Global global;
     ...
     * 静态工厂方法
     */
    public static synchronized com.example.commom.config.Global getInstance()
    {
        if (global == null)
        {
            global = new com.example.commom.config.Global();
        }
        return global;
    }
