...
public class YamlUtil
{
    ...
    {
        InputStream in = com.example.commom.utils.YamlUtil.class.getClassLoader().getResourceAsStream(fileName);
    ...
    public static void dumpYaml(String fileName, Map<?, ?> map) throws IOException
    {
        ...
        {
            FileWriter fileWriter = new FileWriter(com.example.commom.utils.YamlUtil.class.getResource(fileName).getFile());
